...
/**
 * Class Sellvana_FrontendCP_Frontend_Controller
 *
 * @property Sellvana_FrontendCP_Main $Sellvana_FrontendCP_Main
 * @property FCom_Admin_Model_User $FCom_Admin_Model_User
 * @property FCom_Core_Main $FCom_Core_Main
 */
class Sellvana_FrontendCP_Frontend_Controller extends FCom_Admin_Controller_Abstract
{
    ...
    public function action_update__PUT()
    {
        ...
        try {
            ...
            $handlers = $this->Sellvana_FrontendCP_Main->getEntityHandlers();
