...
class Sellvana_IndexTank_Admin extends BClass
{
        ...
        if ($this->BConfig->get('modules/Sellvana_IndexTank/api_url')) {
            ...
            if (0 == $this->BConfig->get('modules/Sellvana_IndexTank/disable_auto_indexing')) {
                $this->BEvents->on('Sellvana_Catalog_Model_Product::onAfterSave', 'Sellvana_IndexTank_Admin::onProductAfterSave')
                    ...
                    //for custom fields
                    ->on('FCom_Core_Model_Field::onAfterSave', 'Sellvana_IndexTank_Admin::onCustomFieldAfterSave')
                    ->on('FCom_Core_Model_Field::onBeforeDelete', 'Sellvana_IndexTank_Admin::onCustomFieldBeforeDelete')
                ;
            }
    ...
    /**
     * Catch event FCom_Core_Model_Field::afterSave
    ...
    /**
     * Catch event FCom_Core_Model_Field::BeforeDelete
