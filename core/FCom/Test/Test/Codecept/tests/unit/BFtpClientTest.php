...
class BFtpClientTest extends \Codeception\TestCase\Test
{
    /**
    ...
    protected function _before()
    {
        ...
        $testFile = dirname(__DIR__) . DIRECTORY_SEPARATOR . '_ftp/test.txt';
    ...
    public function testFtpUpload()
    {
        ...
        $from = dirname(__DIR__) . DIRECTORY_SEPARATOR . '_ftp/test.txt';
        $to   = '_ftp/test.txt';
