...
class BDbTest extends \Codeception\TestCase\Test
{
    /**
    ...
    protected function _before()
    {
        ...
        $db->ddlClearCache();
        $this->dbConfig = include $this->tester->getDbConfigFile();
        \BConfig::i()->add(
    ...
    public function testDdlTableDefCanCreateTable()
    {
        ...
        $this->assertFalse($db->ddlTableExists('sellvana_test.' . $vo->table));

        $db->ddlTableDef($vo->table, $vo->tableFields);

        $this->assertTrue($db->ddlTableExists($vo->table));
        $this->assertTrue($db->ddlTableExists('sellvana_test.' . $vo->table));
    }
