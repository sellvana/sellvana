...
class BImportTest extends \Codeception\TestCase\Test
{
    /**
    ...
    {
        $dir = sprintf('%s/%s/import/%s', FCom_Core_Main::i()->dir('storage'), BConfig::i()->get('core/storage_random_dir'), $this->object->getDir());
