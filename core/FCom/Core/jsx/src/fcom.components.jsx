    ...
    FCom.Components.ControlInput = React.createClass({
        ...
        render: function () {
            ...
            switch (this.props.input_type) {
                case 'textarea':
                    node = <textarea {...this.props.attrs} onChange={this.handleChange} onBlur={this.props.callback} value={this.state.value} />;
                    break;
                case 'select':
                    break;
                default:
                    node = <input {...this.props.attrs} onChange={this.handleChange} onBlur={this.props.callback} value={this.state.value} />;
                    break;
            }
            return node;
        }
