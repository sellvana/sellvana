...
define(['jquery', 'react', 'underscore', 'fcom.locale', 'sortable', 'dropzone', 'bootstrap', 'select2', 'jquery.validate'], function ($, React, _, Locale, Sortable, Dropzone) {
    ...
    FCom.Components.ControlInput = React.createClass({
        ...
        render: function () {
            ...
            switch (this.props.type) {
                case 'textarea':
                    node = <textarea id={this.props.id || uuid}
                ...
                case 'select':
                    ...
                    node = <select id={this.props.id || uuid}
                            name={this.props.name || uuid}
                            className={"form-control " + this.props.className}
                            onChange={this._handleChange}
    ...
    FCom.Components.Modal = React.createClass({
        ...
        render: function () {
            ...
            if (this.props.confirm) {
                confirmButton = (
                    <FCom.Components.Button type="button" onClick={this._handleConfirm}
            ...
            if (this.props.cancel) {
                cancelButton = (
                    <FCom.Components.Button onClick={this._handleCancel} className={"btn-default " + (this.props.cancelClass || '')} type="button">
                        {this.props.cancel}
                    </FCom.Components.Button>
                );
            }
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                {cancelButton ? <button type="button" className="close" onClick={this._handleCancel}>
                                    &times;
                                </button> : null}
    ...
    FCom.Components.Select2 = React.createClass({
        ...
        render: function () {
            return <input type='hidden' id={this.props.id} name={this.props.name} style={this.props.style} {...this.props.attrs}/>;
        }
    });
    ...
    FCom.Components.RatingWidget = React.createClass({
        ...
        render: function () {
            ...
            return (
                <div className={classes} onMouseLeave={this._handleOnMouseLeave}>
                    {ratingSteps}
                </div>
            );
        }
    ...
    FCom.Components.Dropzone = React.createClass({
        ...
        render: function () {
            ...
            if (config.showHiddenInput) {
                ...
                customHiddenInput = <input type="hidden" name={this.props.name} {...inputAttrs}/>;
            }
