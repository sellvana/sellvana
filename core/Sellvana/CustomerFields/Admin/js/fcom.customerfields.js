define(['jquery', 'underscore', 'backbone', 'marionette'], function ($, _, Backbone, Marionette) {
    ...
    CustomFields.Views.Field = Backbone.Marionette.ItemView.extend({
        template: '#customers-customerfields-template',
        tagName: 'li',
        ui: {
            value: '.value'
        },
    ...
    CustomFields.Views.Fields = Backbone.Marionette.CompositeView.extend({
        el: '#customer-edit-customerfields',
        itemView: CustomFields.Views.Field,
        itemViewContainer: '#customer-customerfields-fields',
        ui: {
            availSets: '#customer-edit-available-sets',
            //addSet: '#customer-edit-add-set',
            availFields: '#customer-edit-available-fields'
            //addField: '#customer-edit-add-field',
        },
        events: {
            'click #customer-edit-add-set': 'onSetAdd',
            'click #customer-edit-add-field': 'onFieldAdd'
        },
        collectionEvents: {
            'all': 'update'
        },
