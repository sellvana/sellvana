...
/**
 * Class Sellvana_PaymentIdeal_PaymentMethod
 *
 * @property Sellvana_Sales_Model_Order_Payment $Sellvana_Sales_Model_Order_Payment
 * @property Sellvana_Sales_Model_Order $Sellvana_Sales_Model_Order
 */
class Sellvana_PaymentIdeal_PaymentMethod extends Sellvana_Sales_Method_Payment_Abstract
{
    ...
    public function payOnCheckout(Sellvana_Sales_Model_Order_Payment $payment)
    {
        ...
        $paymentModel = $this->Sellvana_Sales_Model_Order_Payment->create($paymentData)->save();
...
// API methods
    ...
    {
        $payment = $this->Sellvana_Sales_Model_Order_Payment->load($transactionId, 'transaction_id');
        return $payment;
    }
}
