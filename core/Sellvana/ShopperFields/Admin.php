        ...
        $config = [
            'config' => [
                ...
                'columns' => [
                    ['type' => 'row_select'],
                    ['name' => 'id', 'label' => 'ID', 'width' => 30, 'hidden' => true],
                    ['type' => 'input', 'name' => 'label', 'multilang' => ['id' => 'name', 'locales' => $this->BLocale->parseAllowedLocalesToOptions(), 'callback' => 'saveShopperLangField'], 'label' => 'Field name (Product Name)', 'width' => 300, 'editable' => 'inline', 'sortable' => false, 'validation' => ['required' => true], 'callback' => 'editShopperOptionLabelCallback', 'cssClass' => 'optionLabelUnique '],
