...
/**
 * Class Sellvana_Email_Frontend_Controller
 *
 * @property Sellvana_Email_Model_Pref $Sellvana_Email_Model_Pref
 */
class Sellvana_Email_Frontend_Controller extends FCom_Frontend_Controller_Abstract
{
    ...
    {
        $hlp = $this->Sellvana_Email_Model_Pref;
        $r = $this->BRequest;
    ...
    public function action_subscribe__POST()
    {
        ...
        $post = $r->post();
        try {
            $model = $this->Sellvana_Email_Model_Pref->load($post['email'], 'email');
            /** @var $model Sellvana_Email_Model_Pref */
            if (!$model) {
                $model = $this->Sellvana_Email_Model_Pref->create();
            }
