...
/**
 * Class Sellvana_Sales_Admin_Controller_Report_State
 */
class Sellvana_Sales_Admin_Controller_Report_State extends FCom_Admin_Controller_Abstract_Report
{
    ...
    public function gridConfig()
    {
        ...
        $config['columns'] = [
            ['name' => 'billing_state', 'index' => 'billing_state', 'label' => 'State', 'width' => 100],
    ...
    public function gridOrmConfig($orm)
    {
        ...
        $orm->select_expr('IFNULL(billing_region, billing_country)', 'billing_state')
