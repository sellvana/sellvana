...
/**
 * Class Sellvana_CatalogFields_Tests_Model_FieldOptionTest
 *
 * @property Sellvana_CatalogFields_Model_FieldOption $Sellvana_CatalogFields_Model_FieldOption
 */

class Sellvana_CatalogFields_Tests_Model_FieldOptionTest extends FCom_Test_DatabaseTestCase
{
    ...
    public function testAddEntry()
    {
        ...
        $this->Sellvana_CatalogFields_Model_FieldOption->create($data)->save();
    ...
    public function testDeleteEntry()
    {
        ...
        $fieldOption = $this->Sellvana_CatalogFields_Model_FieldOption->load(2);
        $fieldOption->delete();
