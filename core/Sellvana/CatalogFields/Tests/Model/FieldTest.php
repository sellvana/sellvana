...
/**
 * Class Sellvana_CatalogFields_Tests_Model_FieldTest
 *
 * @property Sellvana_CatalogFields_Model_Field $Sellvana_CatalogFields_Model_Field
 */

class Sellvana_CatalogFields_Tests_Model_FieldTest extends FCom_Test_DatabaseTestCase
{
    ...
    public function testAddEntry()
    {
        ...
        $field = $this->Sellvana_CatalogFields_Model_Field->create($data)->save();
    ...
    public function testDeleteEntry()
    {
        ...
        $field2 = $this->Sellvana_CatalogFields_Model_Field->load(2);
        $this->BDb->ddlClearCache();
