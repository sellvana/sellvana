            ...
            'config' => [
                ...
                'columns' => [
                    ...
                    ['name' => 'langs', 'label' => 'Multi Languages', 'width' => 300, 'editor' => 'select',
                        'editable' => 'inline', 'type' => 'input', 'addable' => true, 'sortable' => false, 'options' => $this->BUtil->localesToSelect2Options(), 'select2' => true, 'multiple' => true, 'placeholder' => 'Select some languages', 'callback' => 'addLangField'],
