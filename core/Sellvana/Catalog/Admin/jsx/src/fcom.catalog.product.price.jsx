...
define(['jquery', 'underscore', 'react', 'fcom.locale', 'daterangepicker'], function ($, _, React, Locale) {
                ...
                <div id={this.props.id + "-prices"}>
                    ...
                    <table className={"table table-striped " + this.props.id + "-prices-table"}>
                        ...
                        <tr className="table-actions" style={{backgroundColor: "#ccc"}}>
                            <td></td>
                            <td>
                                <select id={"price-types-" + this.props.id} data-id={this.props.id} className="form-control" ref="price-types" onChange={this.props.addNewPrice.bind(null, this.props.addPriceTypeCallback)}>
    ...
    var Price = React.createClass({
        ...
        render: function() {
            ...
            return (
                <PricesApp {...this.props.options} id={this.props.id} />
            );
        }
    });
