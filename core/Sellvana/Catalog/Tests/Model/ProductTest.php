...
/**
 * Class Sellvana_Catalog_Tests_Model_ProductTest
 *
 * @property Sellvana_Catalog_Model_Product $Sellvana_Catalog_Model_Product
 */

class Sellvana_Catalog_Tests_Model_ProductTest extends FCom_Test_DatabaseTestCase
{
    ...
    public function testAddEntry()
    {
        ...
        $this->Sellvana_Catalog_Model_Product->create($data)->save();
    ...
    public function testRemoveEntry()
    {
        ...
        $id = 2;
        $entry = $this->Sellvana_Catalog_Model_Product->load($id);
        $entry->delete();
    ...
    public function testGeneratingUrlKey()
    {
        ...
        $entry = $this->Sellvana_Catalog_Model_Product->load(3);
    ...
    public function testUrlKeyAlgorithm()
    {
        ...
        $data = ['id' => 3, 'product_name' => 'Product 3'];
        $entry = $this->Sellvana_Catalog_Model_Product->create($data)->save();
