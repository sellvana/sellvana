...
class Sellvana_CustomField_Test_Unit_FieldTest extends FCom_Test_DatabaseTestCase
{
    ...
    public function testAddEntry()
    {
        ...
        $field = Sellvana_CustomField_Model_Field::i()->create($data)->save();
    ...
    public function testDeleteEntry()
    {
        ...
        $field2 = Sellvana_CustomField_Model_Field::i()->load(2);
        BDb::i()->ddlClearCache();
