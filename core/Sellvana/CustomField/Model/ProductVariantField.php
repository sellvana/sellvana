...
class Sellvana_CustomField_Model_ProductVariantField extends FCom_Core_Model_Abstract
{
    ...
    protected static $_importExportProfile = [
        'related' => [
            ...
            'varfield_id' => 'Sellvana_CustomField_Model_Varfield.id',
            'option_id' => 'Sellvana_CustomField_Model_FieldOption.id',
        ],
