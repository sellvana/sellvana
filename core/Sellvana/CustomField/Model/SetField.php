...
/**
 * Class Sellvana_CustomField_Model_SetField
 *
 * @property int $id
 * @property int $set_id
 ...
 */
class Sellvana_CustomField_Model_SetField extends FCom_Core_Model_Abstract
{
    ...
    protected static $_importExportProfile = [
        ...
        'related'    => ['set_id'   => 'Sellvana_CustomField_Model_Set.id',
