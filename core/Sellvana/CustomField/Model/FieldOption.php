...
/**
 * Class Sellvana_CustomField_Model_FieldOption
 *
 * @property int $id
 ...
 */
class Sellvana_CustomField_Model_FieldOption extends FCom_Core_Model_Abstract
{
    protected static $_origClass = __CLASS__;
    protected static $_table = 'fcom_field_option';
    protected static $_importExportProfile = [
        'unique_key' => ['field_id', 'label'],
        'related' => ['field_id' => 'Sellvana_CustomField_Model_Field.id']];

    public function getListAssocById($fieldId)
    {
        $result = [];
        /** @var Sellvana_CustomField_Model_FieldOption[] $options */
