...
/**
 * Class Sellvana_CustomField_Model_ProductVariant
 *
 * @property int $id
...
class Sellvana_CustomField_Model_ProductVariant extends FCom_Core_Model_Abstract
{
    ...
    public function fetchProductVariantsData($product)
    {
        ...
        /** @var Sellvana_CustomField_Model_ProductVarfield[] $varModels */
        ...
        $varImageHlp = $this->Sellvana_CustomField_Model_ProductVariantImage;
