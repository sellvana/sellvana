...
/**
 * Class Sellvana_CustomField_Tests_Model_FieldTest
 *
 * @property Sellvana_CustomField_Model_Field $Sellvana_CustomField_Model_Field
 */

class Sellvana_CustomField_Tests_Model_FieldTest extends FCom_Test_DatabaseTestCase
{
    ...
    public function testAddEntry()
    {
        ...
        $field = $this->Sellvana_CustomField_Model_Field->create($data)->save();
    ...
    public function testDeleteEntry()
    {
        ...
        $field2 = $this->Sellvana_CustomField_Model_Field->load(2);
        $this->BDb->ddlClearCache();
