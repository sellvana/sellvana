...
/**
 * Class FCom_SalesTax_Admin_Controller_Zones
 *
 * @property FCom_SalesTax_Model_Zone $FCom_SalesTax_Model_Zone
 */
class FCom_SalesTax_Admin_Controller_Zones extends FCom_Admin_Controller_Abstract_GridForm
{
    protected static $_origClass = __CLASS__;

    protected $_gridHref = 'salestax/zones';
    protected $_modelClass = 'FCom_SalesTax_Model_Zone';
    ...
    public function gridConfig()
    {
        ...
        $zoneTypeOptions = $this->FCom_SalesTax_Model_Zone->fieldOptions('zone_type');
    ...
    public function action_unique__POST()
    {
        ...
        $data = each($post);
        $rows = $this->BDb->many_as_array($this->FCom_SalesTax_Model_Zone->orm()
