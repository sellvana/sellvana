...
/**
 * Class FCom_SalesTax_Admin_Controller_CustomerClasses
 *
 * @property FCom_SalesTax_Model_CustomerClass $FCom_SalesTax_Model_CustomerClass
 */
class FCom_SalesTax_Admin_Controller_CustomerClasses extends FCom_Admin_Controller_Abstract_GridForm
{
    protected static $_origClass = __CLASS__;

    protected $_gridHref = 'salestax/customer-classes';
    protected $_modelClass = 'FCom_SalesTax_Model_CustomerClass';
...
//            'new' => array('caption' => 'Add New Customer Group', 'modal' => true),
    ...
    public function action_unique__POST()
    {
        ...
        $data = each($post);
        $rows = $this->BDb->many_as_array($this->FCom_SalesTax_Model_CustomerClass->orm()
