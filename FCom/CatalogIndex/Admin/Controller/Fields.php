...
class FCom_CatalogIndex_Admin_Controller_Fields extends FCom_Admin_Controller_Abstract_GridForm
{
    ...
    public function gridConfig()
    {
        ...
        $config[ 'columns' ] = [
            ...
            [ 'type' => 'input', 'name' => 'field_name', 'label' => 'Name', 'index' => 'idxf.field_name', 'editable' => true, 'addable' => true,
                  'validation' => [ 'required' => true, 'unique' => BApp::href( 'catalogindex/fields/unique' ), 'maxlength' => 50 ] ],
            [ 'type' => 'input', 'name' => 'field_label', 'label' => 'Label', 'index' => 'idxf.field_label', 'editable' => true, 'addable' => true,
                  'validation' => [ 'required' => true, 'maxlength' => 50 ] ],
            [ 'type' => 'input', 'name' => 'field_type', 'label' => 'Type', 'index' => 'idxf.field_type', 'width' => 80, 'editable' => true, 'addable' => true,
                  'editor' => 'select', 'options' => $fieldHlp->fieldOptions( 'field_type' ) ],
            [ 'type' => 'input', 'name' => 'filter_type', 'label' => 'Facet', 'index' => 'idxf.filter_type', 'width' => 80, 'editable' => true, 'addable' => true,
                  'editor' => 'select', 'options' => $fieldHlp->fieldOptions( 'filter_type' ) ],
            [ 'type' => 'input', 'name' => 'filter_multivalue', 'label' => 'Multi Value', 'index' => 'idxf.filter_multivalue', 'width' => 80,
                  'addable' => true, 'editable' => true, 'mass-editable' => true, 'editor' => 'select',
                  'options' => $fieldHlp->fieldOptions( 'filter_multivalue' ) ],
            [ 'type' => 'input', 'name' => 'filter_counts', 'label' => 'Calc Counts', 'index' => 'idxf.filter_counts', 'width' => 80, 'addable' => true,
                  'editable' => true, 'editor' => 'select', 'options' => $fieldHlp->fieldOptions( 'filter_counts' ) ],
            [ 'type' => 'input', 'name' => 'filter_show_empty', 'label' => 'Show Empty', 'index' => 'idxf.filter_show_empty', 'width' => 80,
                  'editor' => 'select', 'addable' => true, 'editable' => true, 'options' => $fieldHlp->fieldOptions( 'filter_show_empty' ) ],
            [ 'type' => 'input', 'name' => 'filter_order', 'label' => 'Facet Order', 'index' => 'idxf.filter_order', 'addable' => true, 'editable' => true ],
            [ 'name' => 'filter_custom_view', 'label' => 'Facet Custom View', 'index' => 'idxf.filter_custom_view', 'width' => 80, 'hidden' => true, 'editable' => true, 'display' => 'eval',
                  'element_print' => '<input readonly name="filter_custom_view" id="filter_custom_view" type="text" class="form-control">', 'editor' => 'none' ],
            [ 'type' => 'input', 'name' => 'search_type', 'label' => 'Search', 'index' => 'idxf.search_type', 'editor' => 'select',
                  'options' => $fieldHlp->fieldOptions( 'search_type' ), 'width' => 80, 'addable' => true, 'editable' => true ],
            [ 'type' => 'input', 'name' => 'sort_type', 'label' => 'Sort', 'index' => 'idxf.sort_type', 'editor' => 'select', 'addable' => true,
                  'editable' => true, 'options' => $fieldHlp->fieldOptions( 'sort_type' ), 'width' => 80 ],
            [ 'type' => 'input', 'name' => 'sort_label', 'label' => 'Sort Label', 'index' => 'idxf.sort_label', 'width' => 80, 'addable' => true, 'editable' => true ],
            [ 'name' => 'sort_order', 'label' => 'Sort Order', 'index' => 'idxf.sort_order', 'width' => 80, 'addable' => true, 'editable' => true ],
            [ 'type' => 'input', 'name' => 'source_type', 'label' => 'Source', 'index' => 'idxf.source_type', 'options' => $fieldHlp->fieldOptions( 'source_type' ),
                  'editor' => 'select', 'width' => 80, 'addable' => true, 'editable' => true ],
            [ 'name' => 'source_callback', 'label' => 'Source Callback', 'index' => 'idxf.source_callback', 'width' => 80, 'hidden' => true ],
