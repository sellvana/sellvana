...
class FCom_Ogone extends BClass
{
    ...
    static public function bootstrap()
    {
        ...
        FCom_Sales::i()
            ->registerPaymentMethod('ogone', 'FCom_Ogone_PaymentMethod')
            ->registerCheckoutMethod('ogone', 'FCom_Ogone_CheckoutMethod')
        ;
    }
    ...
    public function prepareRequestData()
    {
        ...
        $homeUrl = FCom_Core::i()->frontendHref('');
        $callbackUrl = FCom_Core::i()->frontendHref('ogone/callback');
        $data = array(
            'RL' => 'ncol_2.0',
            'PSPID' => $conf->pspid,
            ...
            'TITLE' => $conf->title,
            'TP' => $conf->template ? FCom_Core::i()->frontendHref('ogone/template') : null,
            'LOGO' => $conf->logo,
