    ...
    <div class="col-customer-address" ng-controller="CustomerAddressesCtrl" ng-show="true" style="display:none">
        ...
        <div ng-repeat="a in addresses">
            ...
            <div class="adr">
                ...
                <span class="region">
                    <select ng-show="a.edit_mode && regions[a.country]" ng-options="name for (key,name) in regions[a.country]" ng-model="a.region" fcom-select2><option></option></select>
                ...
                <div class="country-name">
                    <select ng-show="a.edit_mode" ng-options="key as name for (key,name) in countries" ng-model="a.country" fcom-select2><option></option></select>
