...
<div class="main col1-layout">
    ...
    <div class="col-main">
        <? if (!$xhr): ?><a href="<?=$this->q(FCom_Core::lastNav())?>">&lt;&lt; Back to results</a><? endif ?>
...
<? if (!empty($this->products[$i])): $p = $this->products[$i]; ?>
                <p><a href="#" class="remove-trigger" onclick="$('.block-compare').data('compare').remove(<?=$p->id?>, this)">Remove</a></p>
