...
class FCom_Catalog_Admin extends BClass
{
    static public function bootstrap()
    {
        BEvents::i()
            ...
            ->on('FCom_Admin_Admin_Controller_MediaLibrary::gridConfig:media/product/attachment',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridConfig', array('type'=>'A'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::action_grid_get:media/product/attachment.orm',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridGetORM', array('type'=>'A'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::processGridPost:media/product/attachment.upload',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridUpload', array('type'=>'A'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::processGridPost:media/product/attachment.edit',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridEdit', array('type'=>'A'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::gridConfig:media/product/image',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridConfig', array('type'=>'I'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::action_grid_get:media/product/image.orm',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridGetORM', array('type'=>'I'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::processGridPost:media/product/image.upload',
                'FCom_Catalog_Admin_Controller_Products.onMediaGridUpload', array('type'=>'I'))

            ->on('FCom_Admin_Admin_Controller_MediaLibrary::processGridPost:media/product/image.edit',
        ...
        FCom_Admin_Admin_Controller_MediaLibrary::i()
